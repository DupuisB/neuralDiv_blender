...
class OBJECT_OT_NN_Subdivide(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        # Always get the latest network selection from the scene
        selected_network = context.scene.network
        network_path = os.path.join(os.path.dirname(__file__), "data", "jobs", selected_network)
